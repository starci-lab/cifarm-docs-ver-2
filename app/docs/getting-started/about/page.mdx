...
<Image src="/gifs/farm.gif" alt="Farm" width={2000} height={2000} className='w-full rounded-lg mt-4' />
...
<Image src="/gifs/thief.gif" alt="Thieve" width={2000} height={2000} className='w-full rounded-lg mt-4' />

### **Earn 💰**  
Deliver your crop to earn **gold**. You can earn **USDC** by delivering your NFT fruits into the vault.

<Image src="/gifs/deliver.gif" alt="Earn" width={2000} height={2000} className='w-full rounded-lg mt-4' />
